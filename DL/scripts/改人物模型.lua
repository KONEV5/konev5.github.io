local Alice_menu = menu.add_submenu("人物模型")

local function Text(text)

Alice_menu:add_action(text, function() end)
end
...
local delay = 0.01
local currentHash = 0;
Alice_menu:add_float_range("延迟", 0.01, 0.01, 0.5, function() end, function(value) delay = value end)

Alice_menu:add_action("正常皮肤", function()

globals.set_int(2671447+59, 1)
 
globals.set_int(2671447+46,-1667301416)

sleep(0.05)

globals.set_int(2671447+59, 0)

end)



local Alice = player.get_player_ped(localplayer:get_player_id())
...
globals.set_int(2671447+46, hash)
...
Alice_menu:add_int_range("女性皮肤", 1, 1, #Alice1, function() end, function(value)

sethash(Alice1[value][2]) 
...
Alice_menu:add_action("随机女性皮肤", function()
			
local Alice = math.floor(math.random(1, #Alice1))
		
sethash(Alice1[Alice][2])
...
Alice_menu:add_int_range("男性皮肤", 1, 1, #Alice2, function() end, function(value)

sethash(Alice2[value][2]) 
...
Alice_menu:add_action("随机男性皮肤", function()
			
local Alice = math.floor(math.random(1, #Alice2))
		
sethash(Alice2[Alice][2])
	
end)


 
Alice_menu:add_int_range("动物皮肤", 1, 1, #Alice3, function() end, function(value)
 
sethash(Alice3[value][2])
...
Alice_menu:add_action("随机动物皮肤", function()
			
local Alice = math.floor(math.random(1, #Alice3))
		
sethash(Alice3[Alice][2])
